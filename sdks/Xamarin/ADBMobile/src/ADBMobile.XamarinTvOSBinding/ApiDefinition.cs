...
namespace Com.Adobe.Mobile
{
	...
	interface ADBMobile
	{
		...
		[Static]
		[Export("keepLifecycleSessionAlive")]
		void KeepLifecycleSessionAlive();

		// +(void)collectLifecycleData;
		[Static]
		[Export("collectLifecycleData")]
		void CollectLifecycleData();
		...
		[Static]
		[Export("registerAdobeDataCallback:")]
		...
		[Static]
		[Export("trackActionFromBackground:data:")]
		...
		[Static]
		[Export("trackLifetimeValueIncrease:data:")]
		...
		[Static]
		[Export("trackTimedActionUpdate:data:")]
		...
		[Static]
		[Export("trackTimedActionEnd:logic:")]
		...
		[Static]
		[Export("trackingTimedActionExists:")]
		...
		[Static]
		[Export("mediaCreateSettingsWithName:length:playerName:playerID:")]
		...
		[Static]
		[Export("mediaAdCreateSettingsWithName:length:playerName:parentName:parentPod:parentPodPosition:CPM:")]
		...
		[Static]
		[Export("mediaOpenWithSettings:callback:")]
		...
		[Static]
		[Export("targetLoadRequest:callback:")]
		...
		[Static]
		[Export("targetLoadRequestWithName:defaultContent:profileParameters:orderParameters:mboxParameters:callback:")]
		...
		[Static]
		[Export("targetLoadRequestWithName:defaultContent:profileParameters:orderParameters:mboxParameters:requestLocationParameters:callback:")]
		...
		[Static]
		[Export("targetCreateRequestWithName:defaultContent:parameters:")]
		[return: NullAllowed]
		...
		[Static]
		[Export("targetCreateOrderConfirmRequestWithName:orderId:orderTotal:productPurchasedId:parameters:")]
		[return: NullAllowed]
		...
		[Static]
		[Export("targetSessionID")]
		string TargetSessionID();

		// +(NSDictionary * _Nullable)audienceVisitorProfile;
		[Static]
		[Export("audienceVisitorProfile")]
		[return: NullAllowed]
		...
		[Static]
		[Export("visitorSyncIdentifiers:authenticationState:")]
		...
		[Static]
		[Export("visitorSyncIdentifierWithType:identifier:authenticationState:")]
		...
		[Static]
		[Export("visitorGetIDs")]
		[return: NullAllowed]
		NSString[] VisitorGetIDs();

		// +(NSURL * _Nullable)visitorAppendToURL:(NSURL * _Nullable)url;
		[Static]
		[Export("visitorAppendToURL:")]
		[return: NullAllowed]
		NSUrl VisitorAppendToURL([NullAllowed] NSUrl url);
